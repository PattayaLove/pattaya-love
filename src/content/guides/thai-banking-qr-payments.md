---
title: "Thai Bank Account & QR Payments for Foreigners — 2026 Guide"
...
**How to set up:**
1. Download the Wise app (if you don't have it already)
2. Complete identity verification
3. Load THB balance (or auto-convert from your home currency)
4. Scan Thai QR codes directly from the app
...
**How it works:**
1. Download the TAGTHAi app
2. Visit a KBank FX booth in person (available at airports and major malls)
3. Present your passport to get a PAY&TOUR prepaid card
4. Top up the card and link it to PromptPay
5. Scan QR codes like a local

**Pros:** Official, government-supported, designed for tourists
**Cons:** Requires in-person visit to a booth, limited top-up locations
...
**Pros:** No Thai bank account or e-wallet needed, works with Western cards
**Cons:** Newer service, availability at all merchants not guaranteed, transaction fees may apply
